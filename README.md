...
- 🔒 **Cryptographic Security**: Full CAP-0059 implementation with pairing checks, H2C, and subgroup verification

**Built with:**

- ⚡️ [Scaffold Stellar](https://github.com/AhaLabs/scaffold-stellar) - Vite + React + TypeScript
- 🦀 Soroban smart contracts in Rust
- 🔐 OpenZeppelin Stellar Contracts for NFT standards
- 📡 Drand Quicknet (3-second rounds)
...
│       ├── src/lib.rs           # Contract logic with BLS12-381 verification
│       └── Cargo.toml
├── docs/
│   ├── specs/                   # Game design specifications
│   └── reference-implementations/ # Solidity & JS reference code
├── packages/                    # Auto-generated TypeScript clients
│   └── gene_splicer/           # Contract bindings (generated by scaffold)
├── public/
│   └── assets/creatures/        # Gene segment PNG assets (15 variants)
├── scripts/                     # Utility scripts
│   ├── getDrandPubkey.ts       # Extract drand public key
│   ├── testBLS12381.sh         # End-to-end BLS verification test
│   └── fetchAndDecompressDrand.ts
├── src/                         # Frontend React application
│   ├── components/
│   │   ├── GenomeSplicer.tsx   # Main game UI
│   │   └── CreatureRenderer.tsx # Dynamic creature rendering
│   ├── contracts/
│   │   ├── gene_splicer.ts     # Contract client wrapper
│   │   └── util.ts             # Network utilities
│   ├── services/
│   │   └── entropyRelayer.ts   # BLS12-381 point decompression
│   ├── hooks/                   # React hooks for wallet, balance, etc.
│   ├── pages/                   # App routes
│   └── App.tsx
├── .github/workflows/
